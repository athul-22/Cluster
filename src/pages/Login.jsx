...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await fetch("https://cluster-backend.onrender.com/auth/login", {
        method: "POST",
        headers: {
        ...
        <div className='hidden w-1/2 h-full lg:flex flex-col items-center justify-center bg-blue'>
          ...
          <div className='mt-16 text-center'>
            <p className='text-white text-base'>
              Connect with friends on Cluster
            </p>
            <span className='text-sm text-white/80'>
              Connect Minds, Ignite Ideas: Your Academic Hub for Collaborative Excellence.
            </span>
          </div>
        </div>
      </div>
